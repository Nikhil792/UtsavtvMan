...
API_ID = int(environ.get('API_ID', '34082336'))
API_HASH = environ.get('API_HASH', '523c1210dd24185886965228165ded82')
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6809312972,6667067260').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003649386110').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004264597363'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '0'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1004485549351'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1004264597363'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1004407222422')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1004407222422').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1004407222422').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://drive.google.com/file/d/1eRqMRFzn9OWQFyjN8aXRXePveZaCGJlP/view?usp=drivesdk')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'mr.kannan.10@superyes')
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://NIK:NIK@cluster0.1rjthrn.mongodb.net/?appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://utsavbot:utsavbot@utsavbota.ow7iq72.mongodb.net/?appName=utsavbota")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1004264597363'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/nsUtsavTvBot_link_verify/3')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '343270ee17954ccb21bdb8d0850ff933cc7dc398')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/nsUtsavTvBot_link_verify/3')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+LTjPpNyLUEs3NDBl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+umQto9yMeONiODll')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Vj15bot')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+kxx85A6IaRdlMTg1')
OWNERID = int(os.environ.get('OWNERID', '6809312972'))  # Replace with the actual admin ID

# ============================
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '8871292693').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/UtsavTvSupportBot')  # Support group link (make sure bot is admin)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003649386110')).split()]
